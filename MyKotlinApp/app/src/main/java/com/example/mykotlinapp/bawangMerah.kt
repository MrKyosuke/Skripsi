...
class bawangMerah : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonStartQuiz.setOnClickListener {
            val intent = Intent(this@bawangMerah, Quiz::class.java)
    ...
    private fun initializeSpeechRecognizer() {
        ...
        speechRecognizer.setRecognitionListener(object : RecognitionListener {
            override fun onReadyForSpeech(params: Bundle?) {
                Toast.makeText(this@bawangMerah, "Listening...", Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onEndOfSpeech() {
                Toast.makeText(this@bawangMerah, "Processing...", Toast.LENGTH_SHORT).show()
            }

            override fun onError(error: Int) {
                val errorMessage = getErrorText(error)
                Toast.makeText(this@bawangMerah, "Error: $errorMessage", Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onResults(results: Bundle?) {
                ...
                Toast.makeText(this@bawangMerah, "Try again! Read it clearly.", Toast.LENGTH_SHORT).show()
            }
